        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2 bgwarning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-md font-weight-bold text-white textuppercase mb-1">Stok Mobil Terdaftar</div>
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('mobil'); ?>"><i class="fas fabook fa-3x text-primary"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2 bgdanger">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-md font-weight-bold text-white textuppercase mb-1">Mobil yang dipinjam</div>
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dipinjam != 0'];
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2 bgsuccess">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-md font-weight-bold text-white textuppercase mb-1">Mobil yang dibooking</div>
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dibooking !=0'];
        ...
        <div class="table-responsive table-bordered col-sm-5 ml-auto mrauto mt-2">
            <div class="page-header">
                <span class="fas fa-book text-warning mt-2"> Data
                    Mobil</span>
                <a href="<?= base_url('mobil'); ?>"><i class="fas fa-search
